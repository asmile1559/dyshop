...
const (
	ProductService_ListProducts_FullMethodName   = "/product_page.ProductService/ListProducts"
	ProductService_GetProduct_FullMethodName     = "/product_page.ProductService/GetProduct"
	ProductService_SearchProducts_FullMethodName = "/product_page.ProductService/SearchProducts"
	ProductService_CreateProduct_FullMethodName  = "/product_page.ProductService/CreateProduct"
	ProductService_ModifyProduct_FullMethodName  = "/product_page.ProductService/ModifyProduct"
	ProductService_DeleteProduct_FullMethodName  = "/product_page.ProductService/DeleteProduct"
)
...
func (c *productServiceClient) ModifyProduct(ctx context.Context, in *ModifyProductReq, opts ...grpc.CallOption) (*ModifyProductResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ModifyProductResp)
	err := c.cc.Invoke(ctx, ProductService_ModifyProduct_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedProductServiceServer) ModifyProduct(context.Context, *ModifyProductReq) (*ModifyProductResp, error) {
...
func _ProductService_ModifyProduct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProductService_ModifyProduct_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var ProductService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "product_page.ProductService",
