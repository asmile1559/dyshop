...
const (
	CartService_AddCart_FullMethodName   = "/cart_page.CartService/AddCart"
	CartService_EmptyCart_FullMethodName = "/cart_page.CartService/EmptyCart"
	CartService_GetCart_FullMethodName   = "/cart_page.CartService/GetCart"
	CartService_ListCart_FullMethodName  = "/cart_page.CartService/ListCart"
)
...
type CartServiceClient interface {
	...
	ListCart(ctx context.Context, in *ListCartReq, opts ...grpc.CallOption) (*ListCartResp, error)
}
...
func (c *cartServiceClient) AddCart(ctx context.Context, in *AddCartReq, opts ...grpc.CallOption) (*AddCartResp, error) {
...
func (c *cartServiceClient) ListCart(ctx context.Context, in *ListCartReq, opts ...grpc.CallOption) (*ListCartResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type CartServiceServer interface {
	...
	ListCart(context.Context, *ListCartReq) (*ListCartResp, error)
...
func (UnimplementedCartServiceServer) AddCart(context.Context, *AddCartReq) (*AddCartResp, error) {
...
func (UnimplementedCartServiceServer) ListCart(context.Context, *ListCartReq) (*ListCartResp, error) {
...
func _CartService_ListCart_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CartServiceServer).ListCart(ctx, req.(*ListCartReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CartService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cart_page.CartService",
