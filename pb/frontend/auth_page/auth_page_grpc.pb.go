...
const (
	AuthService_DeliverToken_FullMethodName = "/auth_page.AuthService/DeliverToken"
	AuthService_VerifyToken_FullMethodName  = "/auth_page.AuthService/VerifyToken"
)
...
type AuthServiceClient interface {
	DeliverToken(ctx context.Context, in *DeliverTokenReq, opts ...grpc.CallOption) (*DeliveryResp, error)
	VerifyToken(ctx context.Context, in *VerifyTokenReq, opts ...grpc.CallOption) (*VerifyResp, error)
}
...
func (c *authServiceClient) DeliverToken(ctx context.Context, in *DeliverTokenReq, opts ...grpc.CallOption) (*DeliveryResp, error) {
...
func (c *authServiceClient) VerifyToken(ctx context.Context, in *VerifyTokenReq, opts ...grpc.CallOption) (*VerifyResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(VerifyResp)
...
type AuthServiceServer interface {
	DeliverToken(context.Context, *DeliverTokenReq) (*DeliveryResp, error)
	VerifyToken(context.Context, *VerifyTokenReq) (*VerifyResp, error)
...
func (UnimplementedAuthServiceServer) DeliverToken(context.Context, *DeliverTokenReq) (*DeliveryResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeliverToken not implemented")
}
func (UnimplementedAuthServiceServer) VerifyToken(context.Context, *VerifyTokenReq) (*VerifyResp, error) {
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "auth_page.AuthService",
