...
const (
	CheckoutService_Checkout_FullMethodName          = "/checkout_page.CheckoutService/Checkout"
	CheckoutService_GetOrderWithItems_FullMethodName = "/checkout_page.CheckoutService/GetOrderWithItems"
)
...
type CheckoutServiceClient interface {
	...
	GetOrderWithItems(ctx context.Context, in *GetOrderReq, opts ...grpc.CallOption) (*GetOrderResp, error)
}
...
func (c *checkoutServiceClient) GetOrderWithItems(ctx context.Context, in *GetOrderReq, opts ...grpc.CallOption) (*GetOrderResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetOrderResp)
	err := c.cc.Invoke(ctx, CheckoutService_GetOrderWithItems_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CheckoutServiceServer interface {
	...
	GetOrderWithItems(context.Context, *GetOrderReq) (*GetOrderResp, error)
...
func (UnimplementedCheckoutServiceServer) GetOrderWithItems(context.Context, *GetOrderReq) (*GetOrderResp, error) {
...
func _CheckoutService_GetOrderWithItems_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetOrderReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CheckoutServiceServer).GetOrderWithItems(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CheckoutService_GetOrderWithItems_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CheckoutServiceServer).GetOrderWithItems(ctx, req.(*GetOrderReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CheckoutService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "checkout_page.CheckoutService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _CheckoutService_GetOrderWithItems_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "checkout_page.proto",
}
