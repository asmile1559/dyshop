...
func (x *VerifyTokenReq) Reset() {
	*x = VerifyTokenReq{}
	mi := &file_authx_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*VerifyTokenReq) Descriptor() ([]byte, []int) {
	return file_authx_proto_rawDescGZIP(), []int{1}
}
...
func (x *DeliveryResp) Reset() {
	*x = DeliveryResp{}
	mi := &file_authx_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DeliveryResp) Descriptor() ([]byte, []int) {
	return file_authx_proto_rawDescGZIP(), []int{2}
}
...
func (x *VerifyResp) Reset() {
	*x = VerifyResp{}
	mi := &file_authx_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*VerifyResp) Descriptor() ([]byte, []int) {
	return file_authx_proto_rawDescGZIP(), []int{3}
}
...
func (x *VerifyResp) GetCode() int32 {
	if x != nil {
		return x.Code
	}
	return 0
...
var file_authx_proto_rawDesc = []byte{
	0x0a, 0x0b, 0x61, 0x75, 0x74, 0x68, 0x78, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04, 0x61,
	...
	0x50, 0x0a, 0x0e, 0x56, 0x65, 0x72, 0x69, 0x66, 0x79, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x52, 0x65,
	0x71, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x16, 0x0a, 0x06, 0x6d, 0x65, 0x74, 0x68, 0x6f,
	...
	0x69, 0x22, 0x24, 0x0a, 0x0c, 0x44, 0x65, 0x6c, 0x69, 0x76, 0x65, 0x72, 0x79, 0x52, 0x65, 0x73,
	0x70, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x4b, 0x0a, 0x0a, 0x56, 0x65, 0x72, 0x69, 0x66,
	0x79, 0x52, 0x65, 0x73, 0x70, 0x12, 0x10, 0x0a, 0x03, 0x72, 0x65, 0x73, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x08, 0x52, 0x03, 0x72, 0x65, 0x73, 0x12, 0x17, 0x0a, 0x07, 0x75, 0x73, 0x65, 0x72, 0x5f,
	...
	0x63, 0x6f, 0x64, 0x65, 0x32, 0x8d, 0x01, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x53, 0x65, 0x72,
	...
	0x6f, 0x6d, 0x2f, 0x61, 0x73, 0x6d, 0x69, 0x6c, 0x65, 0x31, 0x35, 0x35, 0x39, 0x2f, 0x64, 0x79,
	0x73, 0x68, 0x6f, 0x70, 0x2f, 0x70, 0x62, 0x2f, 0x62, 0x61, 0x63, 0x6b, 0x65, 0x6e, 0x64, 0x2f,
...
var (
	...
	file_authx_proto_rawDescData = file_authx_proto_rawDesc
)

func file_authx_proto_rawDescGZIP() []byte {
	file_authx_proto_rawDescOnce.Do(func() {
		file_authx_proto_rawDescData = protoimpl.X.CompressGZIP(file_authx_proto_rawDescData)
	})
	return file_authx_proto_rawDescData
}

var file_authx_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
...
func file_authx_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_authx_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
